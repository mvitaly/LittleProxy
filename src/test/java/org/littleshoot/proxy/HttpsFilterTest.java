...
public class HttpsFilterTest {
    ...
    @Ignore @Test public void testHttps() throws Exception {
    ...
    @Test public void testFiltering() throws Exception {
        ...
        // Localhost has certificate issues when proxy connects to it
//        final String url1 = "https://localhost:8924/";
//        final String url2 = "http://localhost:8924/testing";
        final String url1 = "https://www.google.com/";
        final String url2 = "https://www.google.com/intl/en/about/";
        ...
        SelfSignedKeyStoreManager ksm = null;
        //ksm = new SelfSignedKeyStoreManager();
        
		final HttpProxyServer server =
            new DefaultHttpProxyServer(PROXY_PORT, responseFilters, null, ksm, null);
        server.start();
...
//				System.err.println("verify: " + host);
//				try {
//					Thread.sleep(100);
...
//		final HttpProxyServer server =
//				new DefaultHttpProxyServer(PROXY_PORT, (HttpResponseFilters) null, null, null, null);
//		server.start();
